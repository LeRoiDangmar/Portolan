...
export const stroke = {
  edge: {
    ...
    attach: '0.9px dasharray 2 4, {colour.edge-attach}',
    'attach-min-length':
    ...
    mount: '1.6px solid, {colour.edge-mount}',
    floor:
  ...
  zone: {
    isoline: {
      ...
      color: '{colour.zone-isoline-1}…{colour.zone-isoline-6}',
    },
    blob: {
      width: '1px',
      style: 'solid, closed',
      color: '{colour.pastille-network-1}…{colour.pastille-network-6}',
    },
  },
  'stack-outline': {
    width: '1.25px',
    style: 'solid, closed, continuous — no dasharray, no graduation, no fill of any kind',
    color: '{colour.stack-outline}',
  ...
  'band-divider': '0.8px, {colour.band-divider}',
  focus: '2px {colour.focus}, 2px offset, square corners, no radius',
} as const;
